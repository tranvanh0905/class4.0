...
<body>
	...
	<main>
		<section id="hero_in" class="courses">
			<div class="wrapper">
				<div class="container">
					<h1 class="fadeInUp"><span></span>Khóa học HTML cơ bản</h1>
				</div>
			</div>
		</section>
		<!--/hero_in-->
		...
		<div class="bg_color_1">
			<nav class="secondary_nav sticky_horizontal">
				<div class="container">
					<ul class="clearfix">
						<li><a href="#description" class="active">Mô tả khóa học</a></li>
				...
				<div class="row">
							...
							<div id="accordion_lessons" role="tablist" class="add_bottom_45">
								<div class="card">
									<div class="card-header" role="tab" id="headingOne">
										<h5 class="mb-0">
											<a data-toggle="collapse" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne"><i class="indicator ti-minus"></i> Giới thiệu về HTML</a>
										</h5>
									</div>
									...
									<div id="collapseOne" class="collapse show" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion_lessons">
										<div class="card-body">
											<div class="list_lessons">
												<ul>
													<li><a href="https://www.youtube.com/watch?v=LDgd_gUcqCw" class="video">Bài 1: HTML là gì ???</a><span>00:59</span></li>
													<li><a href="https://www.youtube.com/watch?v=LDgd_gUcqCw" class="video">Bài 2: Các thẻ cơ bản của HTML</a><span>00:59</span></li>
													<li><a href="#0" class="txt_doc">Bài 3: Bắt đầu tạo HTML</a><span>00:59</span></li>
												</ul>
											</div>
										</div>
									</div>
									...
									<div class="card-header" role="tab" id="headingTwo">
										<h5 class="mb-0">
											<a class="collapsed" data-toggle="collapse" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
												<i class="indicator ti-plus"></i>Các thẻ cơ bản của HTML
											</a>
										</h5>
									</div>
										...
										<div class="card-body">
											<div class="list_lessons">
												<ul>
													<li><a href="https://www.youtube.com/watch?v=LDgd_gUcqCw" class="video">Bài 1: HTML là gì ???</a><span>00:59</span></li>
													<li><a href="https://www.youtube.com/watch?v=LDgd_gUcqCw" class="video">Bài 2: Các thẻ cơ bản của HTML</a><span>00:59</span></li>
													<li><a href="https://www.youtube.com/watch?v=LDgd_gUcqCw" class="video">Bài 3: Bắt đầu tạo HTML</a><span>00:59</span></li>
													<li><a href="https://www.youtube.com/watch?v=LDgd_gUcqCw" class="video">Bài 4: HTML là gì ???</a><span>00:59</span></li>
													<li><a href="#0" class="txt_doc">Bài 5: Bắt đầu tạo HTML</a><span>00:59</span></li>
												</ul>
											</div>
										</div>
									</div>
									...
									<div class="card-header" role="tab" id="headingThree">
										<h5 class="mb-0">
											<a class="collapsed" data-toggle="collapse" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
												<i class="indicator ti-plus"></i>Thực hành HTML
											</a>
										</h5>
									</div>
									...
									<div class="card-header" role="tab" id="headingFourth">
										<h5 class="mb-0">
											<a class="collapsed" data-toggle="collapse" href="#collapseFourth" aria-expanded="false" aria-controls="collapseFourth">
												<i class="indicator ti-plus"></i>Luyện tập HTML
											</a>
										</h5>
									</div>
								...
								<div class="row">
									<div class="col-lg-3">
										<div id="review_summary">
											...
											<small>Có tất cả 4 nhận xét của học viên</small>
										</div>
									</div>
									<div class="col-lg-9">
										<div class="row">
					...
					<aside class="col-lg-4" id="sidebar">
						<div class="box_detail">
							...
							<div class="price">
								1000 VND<span class="original_price"><em>100.000 VND</em></span>
							</div>
							<a href="#0" class="btn_1 full-width">Mua khóa học</a>

							<div id="list_feat">
								<h3>Bạn sẽ nhận được gì ??? </h3>
								<ul>
									<li><i class="icon_mobile"></i>Hỗ trợ 24/24</li>
									<li><i class="icon_archive_alt"></i>Tải về tất cả khóa học</li>
									<li><i class="icon_mobile"></i>Trợ giảng online</li>
									<li><i class="icon_chat_alt"></i>Chat trực tiếp giáo viên</li>
									<li><i class="icon_document_alt"></i>Chứng nhận từ khóa học</li>
								</ul>
							</div>
						</div>
					</aside>
